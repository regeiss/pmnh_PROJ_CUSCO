...
import 'package:gtk_flutter/src/feature/jobs/presentation/job_entries_screen/entry_list_item.dart';
import 'package:gtk_flutter/src/feature/jobs/presentation/job_entries_screen/job_entries_list_controller.dart';
    ...
    return FirestoreListView<Entry>(
      ...
      itemBuilder: (context, doc) {
        ...
        return DismissibleEntryListItem(
          ...
          entry: entry,
          job: job,
          onDismissed: () => ref.read(jobsEntriesListControllerProvider.notifier).deleteEntry(entry.id),
