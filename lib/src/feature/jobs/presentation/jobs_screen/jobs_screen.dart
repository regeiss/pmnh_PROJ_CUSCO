...
import 'package:gtk_flutter/src/feature/jobs/presentation/jobs_screen/jobs_screen_controller.dart';
      ...
      body: Consumer(
        builder: (context, ref, child) {
          ...
          return FirestoreListView<Job>(
            query: jobsQuery,
            emptyBuilder: (context) => const Center(child: Text('Nada aqui')),
            ...
            itemBuilder: (context, doc) {
              ...
              return Dismissible(
                ...
                onDismissed: (direction) => ref.read(jobsScreenControllerProvider.notifier).deleteJob(job),
                child: JobListTile(
                  job: job,
